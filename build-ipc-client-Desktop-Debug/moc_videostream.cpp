...
#include "../ipc-client/src/video/video/videostream.h"
...
QT_MOC_LITERAL(1, 12, 8), // "newFrame"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3) // "img"

    },
    "VideoStream\0newFrame\0\0img"
};
...
void VideoStream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (VideoStream::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoStream::newFrame)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoStream::newFrame(QImage _t1)
{
