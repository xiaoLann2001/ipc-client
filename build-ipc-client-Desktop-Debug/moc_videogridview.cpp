...
#include "../ipc-client/videogridview.h"
...
QT_MOC_LITERAL(4, 61, 42), // "onVideoDisplayUnitRequestMaxi..."
QT_MOC_LITERAL(5, 104, 16), // "displayVideoGrid"
QT_MOC_LITERAL(6, 121, 9), // "QPainter&"
QT_MOC_LITERAL(7, 131, 7) // "painter"

    },
    "VideoGridView\0onVideoDisplayUnitClicked\0"
    "\0id_videodisplayunit\0"
    "onVideoDisplayUnitRequestMaximizeOrRestore\0"
    "displayVideoGrid\0QPainter&\0painter"
};
...
void VideoGridView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onVideoDisplayUnitRequestMaximizeOrRestore((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->displayVideoGrid((*reinterpret_cast< QPainter(*)>(_a[1]))); break;
        default: ;
        }
    }
}
