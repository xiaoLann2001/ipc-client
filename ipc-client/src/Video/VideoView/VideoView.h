...
signals:
    ...
    void videoGridChanged(VideoGridNum grid);
    void videoPageChanged(int page);

    // 传递子窗口的信号到上层
    void videoClicked(int id_videodisplayunit);
    void videoRightClicked(int id_videodisplayunit, const QPoint &pos);
