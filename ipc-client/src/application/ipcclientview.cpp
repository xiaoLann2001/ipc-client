...
void IPCClientView::onVideoPlay(int idx)
{
    widget_videoview->onVideoPlay(idx);
}

void IPCClientView::onVideoStop(int idx)
{
    widget_videoview->onVideoStop(idx);
}

void IPCClientView::onNewFrame(int idx, QImage image)
{
    widget_videoview->onNewFrame(idx, image);
}
